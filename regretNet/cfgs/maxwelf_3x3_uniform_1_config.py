...
__C.dir_name = os.path.join("experiments", "maxwelf_3x3_uniform_1")
...
__C.train.b_w_rgt_init_val = 1.0
__C.train.s_w_rgt_init_val = 1.0
__C.train.b_w_irp_init_val = 1.0
__C.train.s_w_irp_init_val = 1.0
__C.train.a_w_irp_init_val = 1.0
