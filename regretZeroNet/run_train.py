...
cfg.train.restore_iter = cfg.train.max_iter
cfg.train.max_iter = cfg.train.restore_iter + cfg.train.max_iter

Trainer = trainer_zero_regret.Trainer
m = Trainer(cfg, "train", net, clip_op_lambda)
m.train(generator)
